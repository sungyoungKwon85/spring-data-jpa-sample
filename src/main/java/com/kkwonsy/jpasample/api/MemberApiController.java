...
public class MemberApiController {
    ...
    public CreateMemberResponse saveMemberV2(@RequestBody @Valid CreateMemberRequest request) {
        ...
        // tip
        // PC를 여러군대서 쓰다보니 h2 database의 sequence가 안늘어나 있어서 Unique index or primary key violation spring jpa 등의 에러가 발생하면
        // 아래와 같이 시퀀스를 늘리는 SQL을 날리자
        // alter sequence <시퀀스 이름> restart with <next value>
    }
    ...
    public UpdateMemberResponse updateMemberV2(
        ...
        memberService.update(id, request.getName()); // tip 변경감지를 써라
